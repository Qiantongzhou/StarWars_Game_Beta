...
/// <summary>
/// This class is used to move the character along the path
/// </summary>
...
public class AStarAgent : MonoBehaviour
{
    ...
    // and higher priority, and they will be processed earlier in the A* pathfinding algorithm.
    ...
    // this method is to projects the position of the character to the closest point on the grid
    // and then it adds the MovingData of this agent to the point
    // and then it checks if the point is intersecting with other agent's path
    ...
    // this method returns a reconstructed path by calling CheckForIntersections() at the end
    // but the intend is to record the corner points of the path which are used in the SmoothPath() method
    private List<Point> ReconstructPath(PointData start, PointData current, PointData[][][] dataSet)
    {
        ...
        // this part is to find the corner points of the path
        int count = 0;
